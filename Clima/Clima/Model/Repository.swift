...
//    var weatherURL = ""
//
//    func fetchNow(onCompleted: @escaping (Result<WeatherTotalDTO, MyError>) -> Void) {
...
//                onCompleted(.failure(.error))
//                return }
//            guard let weather = try? JSONDecoder().decode(WeatherTotalDTO.self, from: safeData) else {
//                onCompleted(.failure(.error))
//                return }
//
...
//        weatherURL = "\(baseURL)&lat=\(latitude)&lon=\(longitude)"
//    }
//
//}
